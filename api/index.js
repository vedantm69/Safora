...
module.exports = async (req, res) => {
    ...
    if (!parsedUrl.startsWith('/api')) {
        parsedUrl = '/api' + (parsedUrl.startsWith('/') ? parsedUrl : '/' + parsedUrl);
    }
    ...
    return sendJson(res, 200, { status: "ok", service: "SAFORA Serverless API" });
};
